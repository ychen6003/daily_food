...
{id:'b02',meal:['早餐'],name:'茶葉蛋',icon:'🥚',cal:80,carb:1,prot:7,fat:5,
...
{id:'b09',meal:['早餐'],name:'全麥吐司 1片',icon:'🍞',cal:80,carb:15,prot:3,fat:1,
...
{id:'b13',meal:['早餐','午餐','晚餐','訓後補給'],name:'義式香草雞胸肉',icon:'🍗',cal:151,carb:2,prot:27,fat:2,
 cat:'高蛋白',exc:null,pl:'高',cl:'低',fl:'低',fib:'低',proc:'輕加工',sat:'中',
 fit:['rest','cardio','strength','flex'],pre:true,post:true,dinner_ok:true,
 note:'超商即食雞胸，低脂高蛋白'},

{id:'b14',meal:['早餐','午餐','晚餐'],name:'御飯糰（肉鬆）',icon:'🍙',cal:220,carb:38,prot:6,fat:6,
...
{id:'b15',meal:['早餐','午餐','晚餐'],name:'御飯糰（鮪魚）',icon:'🍙',cal:240,carb:40,prot:8,fat:7,
...
{id:'l02',meal:['午餐','晚餐'],name:'海鹽雞胸飯',icon:'🍗',cal:450,carb:48,prot:35,fat:10,
...
{id:'l03',meal:['午餐','晚餐'],name:'烤雞飯（去皮）',icon:'🍗',cal:550,carb:70,prot:40,fat:12,
...
{id:'l04',meal:['午餐','晚餐'],name:'舒肥雞蔬菜餐盒',icon:'🥗',cal:400,carb:20,prot:40,fat:10,
...
{id:'l05',meal:['午餐','晚餐'],name:'香煎雞胸沙拉',icon:'🥗',cal:380,carb:15,prot:38,fat:14,
...
{id:'l06',meal:['午餐','晚餐'],name:'肯德基紙包雞',icon:'🍗',cal:420,carb:8,prot:42,fat:22,
 cat:'高蛋白',subcat:'其他',exc:null,pl:'高',cl:'低',fl:'中',fib:'低',proc:'高加工',sat:'高',
 fit:['rest','cardio','strength','flex'],pre:false,post:false,dinner_ok:true,
 note:'高蛋白低碳，高加工降次選，去皮後脂肪可接受'},

{id:'l07',meal:['午餐','晚餐'],name:'舒肥雞羽衣甘藍捲餅',icon:'🌯',cal:400,carb:35,prot:30,fat:12,
...
{id:'l08',meal:['午餐','晚餐'],name:'滷味拼盤',icon:'🍢',cal:350,carb:20,prot:30,fat:10,
...
{id:'l09',meal:['午餐','晚餐'],name:'烤雞腿飯',icon:'🍗',cal:600,carb:70,prot:35,fat:18,
...
{id:'l10',meal:['午餐','晚餐'],name:'魯雞腿飯',icon:'🍗',cal:600,carb:75,prot:35,fat:18,
 cat:'高蛋白',subcat:'飯',exc:null,pl:'高',cl:'中',fl:'中',fib:'低',proc:'輕加工',sat:'高',
 fit:['cardio','flex'],pre:false,post:true,dinner_ok:true,note:'有氧/彈性日可，脂肪偏中'},

{id:'l11',meal:['午餐','晚餐'],name:'玫瑰雞腿飯',icon:'🍗',cal:650,carb:75,prot:35,fat:20,
 cat:'高蛋白',subcat:'飯',exc:null,pl:'高',cl:'中',fl:'中',fib:'低',proc:'輕加工',sat:'高',
 fit:['cardio','flex'],pre:false,post:true,dinner_ok:true,note:'脂肪中等，有氧/彈性日'},

{id:'l12',meal:['午餐','晚餐'],name:'嫩雞飯',icon:'🍗',cal:650,carb:75,prot:35,fat:22,
 cat:'高蛋白',subcat:'飯',exc:null,pl:'高',cl:'中',fl:'中',fib:'低',proc:'輕加工',sat:'高',
 fit:['cardio','flex'],pre:false,post:true,dinner_ok:true,note:'有氧/彈性日，脂肪偏中'},

{id:'l13',meal:['午餐','晚餐'],name:'甘蔗雞烏龍麵（去皮四塊）',icon:'🍜',cal:420,carb:48,prot:28,fat:6,
...
{id:'l14',meal:['午餐','晚餐'],name:'海鮮烏龍麵（少喝湯）',icon:'🍜',cal:380,carb:55,prot:19,fat:7,
...
{id:'l15',meal:['午餐','晚餐'],name:'越式海鮮河粉',icon:'🍜',cal:475,carb:68,prot:23,fat:8,
 cat:'中碳',subcat:'麵',exc:null,pl:'中',cl:'高',fl:'低',fib:'低',proc:'輕加工',sat:'中',
 fit:['cardio','flex'],pre:false,post:false,dinner_ok:true,note:'有氧日補碳，低脂清湯'},

{id:'l16',meal:['午餐','晚餐'],name:'泰式牛肉河粉',icon:'🍜',cal:575,carb:73,prot:28,fat:15,
...
{id:'l17',meal:['午餐','晚餐'],name:'綜合魷魚羹板條',icon:'🦑',cal:575,carb:78,prot:24,fat:14,
 cat:'中碳',subcat:'麵',exc:null,pl:'中',cl:'高',fl:'中',fib:'低',proc:'輕加工',sat:'高',
 fit:['cardio','flex'],pre:false,post:false,dinner_ok:true,note:'碳水偏高，有氧/彈性日'},

{id:'l18',meal:['午餐','晚餐'],name:'廣東粥',icon:'🥣',cal:300,carb:48,prot:18,fat:8,
...
{id:'l19',meal:['午餐','晚餐'],name:'湯滷味（一般）',icon:'🍢',cal:400,carb:30,prot:25,fat:15,
...
{id:'l20',meal:['午餐','晚餐'],name:'小火鍋（不吃主食）',icon:'🍲',cal:420,carb:18,prot:32,fat:14,
...
{id:'l21',meal:['午餐','晚餐'],name:'小火鍋（烏龍麵）',icon:'🍲',cal:580,carb:72,prot:28,fat:14,
...
{id:'l22',meal:['午餐','晚餐'],name:'牛肉湯餃（10顆）',icon:'🥟',cal:550,carb:60,prot:28,fat:18,
...
{id:'l23',meal:['午餐','晚餐'],name:'蝦餃（8顆）',icon:'🥟',cal:400,carb:50,prot:20,fat:12,
...
{id:'l24',meal:['午餐','晚餐'],name:'鮮肉湯包（8顆）',icon:'🥟',cal:500,carb:55,prot:25,fat:20,
...
{id:'l25',meal:['午餐','晚餐'],name:'水餃 10顆',icon:'🥟',cal:650,carb:70,prot:30,fat:28,
...
{id:'l26',meal:['午餐','晚餐'],name:'摩斯綠烤雞起司堡',icon:'🍔',cal:385,carb:35,prot:23,fat:15,
...
{id:'l27',meal:['午餐','晚餐'],name:'摩斯海洋珍珠堡',icon:'🍔',cal:475,carb:60,prot:18,fat:18,
 cat:'高脂',subcat:'其他',exc:null,pl:'中',cl:'高',fl:'高',fib:'低',proc:'高加工',sat:'中',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高加工，僅彈性日'},

{id:'l28',meal:['午餐','晚餐'],name:'義大利麵（一般）',icon:'🍝',cal:600,carb:80,prot:20,fat:20,
...
{id:'l29',meal:['午餐','晚餐'],name:'松阪豬蔬菜餐盒',icon:'🥩',cal:520,carb:20,prot:30,fat:32,
...
{id:'l30',meal:['午餐','晚餐'],name:'和牛餐盒',icon:'🥩',cal:550,carb:25,prot:40,fat:30,
...
{id:'l31',meal:['午餐','晚餐'],name:'鐵板燒',icon:'🍳',cal:700,carb:40,prot:40,fat:35,
 cat:'高脂',subcat:'其他',exc:null,pl:'高',cl:'低',fl:'高',fib:'低',proc:'輕加工',sat:'高',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高蛋白，僅彈性日'},

{id:'l32',meal:['午餐','晚餐'],name:'黃燜雞米飯（不喝醬）',icon:'🍗',cal:685,carb:90,prot:33,fat:23,
 cat:'高脂',subcat:'飯',exc:null,pl:'高',cl:'高',fl:'高',fib:'低',proc:'輕加工',sat:'高',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高碳，僅彈性日'},

{id:'l33',meal:['午餐','晚餐'],name:'魯排骨飯',icon:'🍖',cal:750,carb:80,prot:28,fat:35,
...
{id:'l34',meal:['午餐','晚餐'],name:'北部粽（1顆）',icon:'🫙',cal:500,carb:65,prot:14,fat:18,
...
{id:'l35',meal:['午餐','晚餐'],name:'炸雞腿飯',icon:'🍗',cal:600,carb:70,prot:30,fat:20,
...
{id:'l36',meal:['午餐','晚餐'],name:'什錦海鮮炒麵',icon:'🍝',cal:700,carb:85,prot:30,fat:25,
 cat:'高脂',subcat:'麵',exc:null,pl:'中',cl:'高',fl:'高',fib:'低',proc:'高加工',sat:'高',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高加工，僅彈性日'},

{id:'l37',meal:['午餐','晚餐'],name:'木須炒麵',icon:'🍝',cal:800,carb:90,prot:30,fat:30,
 cat:'高脂',subcat:'麵',exc:null,pl:'中',cl:'高',fl:'高',fib:'低',proc:'高加工',sat:'高',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高熱量，彈性日控量'},

{id:'l38',meal:['午餐','晚餐'],name:'蝦仁蛋炒飯',icon:'🍳',cal:800,carb:90,prot:25,fat:28,
 cat:'高脂',subcat:'飯',exc:null,pl:'中',cl:'高',fl:'高',fib:'低',proc:'高加工',sat:'高',
 fit:['flex'],pre:false,post:false,dinner_ok:false,note:'高脂高熱量，彈性日控量'},

{id:'l39',meal:['午餐','晚餐'],name:'乾炒牛河粉',icon:'🍜',cal:750,carb:90,prot:28,fat:30,
...
{id:'pre12',meal:['訓前補給'],name:'草莓大福',icon:'🍓',cal:275,carb:50,prot:4,fat:5,
...
// ─────────────── 訓後補給 ───────────────
{id:'post01',meal:['訓後補給'],name:'義式香草雞胸肉＋高蛋白奶',icon:'🍗',cal:311,carb:14,prot:45,fat:5,
 cat:'高蛋白',exc:null,pl:'高',cl:'低',fl:'低',fib:'低',proc:'輕加工',sat:'高',
 fit:['strength'],pre:false,post:true,
 note:'訓後黃金組合，P45g超高蛋白，低脂低碳，肌肉修復首選'},

{id:'post02',meal:['訓後補給'],name:'雞胸肉＋地瓜（中）',icon:'🍗',cal:280,carb:28,prot:30,fat:4,
...
{id:'post03',meal:['訓後補給'],name:'雞胸肉＋白飯（小）',icon:'🍗',cal:380,carb:35,prot:35,fat:8,
 cat:'高蛋白',exc:null,pl:'高',cl:'中',fl:'低',fib:'低',proc:'輕加工',sat:'高',
 fit:['strength'],pre:false,post:true,note:'黃金訓後：高蛋白＋少量碳水'},

{id:'post04',meal:['訓後補給'],name:'舒肥雞蔬菜餐盒',icon:'🥗',cal:400,carb:20,prot:40,fat:10,
 cat:'高蛋白',exc:null,pl:'高',cl:'低',fl:'低',fib:'中',proc:'輕加工',sat:'高',
 fit:['strength'],pre:false,post:true,note:'高蛋白低碳，嚴格控脂訓後首選'},

{id:'post05',meal:['訓後補給'],name:'高蛋白奶 250ml',icon:'🥛',cal:160,carb:12,prot:18,fat:3,
 cat:'高蛋白',exc:null,pl:'高',cl:'低',fl:'低',fib:'低',proc:'輕加工',sat:'低',
 fit:['strength'],pre:false,post:true,note:'不想進食時的快速蛋白補充'},

{id:'post06',meal:['訓後補給'],name:'海鹽雞胸飯（半份）',icon:'🍗',cal:225,carb:24,prot:18,fat:5,
 cat:'高蛋白',exc:null,pl:'高',cl:'低',fl:'低',fib:'低',proc:'輕加工',sat:'中',
 fit:['strength'],pre:false,post:true,note:'輕量訓後，方便外帶半份'},

{id:'post07',meal:['訓後補給'],name:'烤雞腿飯（去皮）',icon:'🍗',cal:500,carb:60,prot:30,fat:14,
